...
export default function TabTwoScreen() {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Heading size='2xl' className='mb-2 relative'>Add Survey</Heading>
      <ScrollView>
        <Box>
            ...
            <VStack space="lg" className='w-full'>
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value }, fieldState: { error } }) => (
                    <Select isInvalid={!!errors.ward_name} onValueChange={(data)=>setValue("ward_name",data)}>
                      <SelectTrigger variant="outline" className='mb-0 rounded-2xl' size="md" >
                        <SelectInput className='pt-1 mt-2 text-sm font-bold' placeholder="Select ward" />
              ...
              <VStack>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field: { onChange, value }, fieldState: { error } }) => (
                    <Select isInvalid={!!errors.details_of_building_carpet_area} onValueChange={(data)=>setValue("details_of_building_carpet_area",data)}>
                      <SelectTrigger variant="outline" className='mb-0 rounded-2xl' size="md" >
                        <SelectInput className='pt-1 mt-2 text-sm font-bold' placeholder="Select Carpet area" />
                        <SelectIcon className="mr-3" as={ChevronDownIcon} />
                      </SelectTrigger>
                      <SelectPortal>
                        <SelectBackdrop />
               ...
               <VStack className='w-96'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field: { onChange, value }, fieldState: { error } }) => (
                    <Select isInvalid={!!errors.details_of_location_a_is_located} onValueChange={(data)=>setValue("details_of_location_a_is_located",data)}>
                      <SelectTrigger variant="outline" className='mb-0 rounded-2xl' size="md" >
                        <SelectInput className='pt-1 mt-2 text-sm font-bold' placeholder="Select Building or Land is located" />
                        <SelectIcon className="mr-3" as={ChevronDownIcon} />
                      </SelectTrigger>
                      <SelectPortal>
                        <SelectBackdrop />
              ...
              <VStack className='w-96'>
                ...
                <Controller
                  ...
                  control={control}
                  render={({ field: { onChange, value }, fieldState: { error } }) => (
                    <Select isInvalid={!!errors.details_of_location_b_nature} onValueChange={(data)=>setValue("details_of_location_b_nature",data)}>
                      <SelectTrigger variant="outline" className='mb-0 rounded-2xl' size="md" >
                        <SelectInput className='pt-1 mt-2 text-sm font-bold' placeholder="Select Nature of Construction of Building" />
                        <SelectIcon className="mr-3" as={ChevronDownIcon} />
                      </SelectTrigger>
                      <SelectPortal>
                        <SelectBackdrop />
